...
export class InitialSchema1745468720277 implements MigrationInterface {
    name = 'InitialSchema1745468720277'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."parking_parkingtype_enum" AS ENUM('public', 'private', 'courtesy')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."parking_parkingtype_enum"`);
    }
